...
export default function PropertyCard({
  ...
  const handleCardClick = () => {
    router.push(`/room_details?id=${id}&type=${propertyType}`);
  };
    ...
    >
      ...
      <div className="relative h-48 bg-gray-200 overflow-hidden">
        {imageUrl ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-gray-300 to-gray-400 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
      ...
      <div className="p-4 group-hover:bg-gradient-to-br group-hover:from-gray-50 group-hover:to-white transition-all duration-300">
        ...
        {/* Key Details */}
        <div className="text-gray-700 text-sm mb-3 group-hover:text-gray-800 transition-colors duration-300">
          {area} - {bedrooms} PN - {bathrooms} WC
        </div>

        {/* Location */}
        <div className="text-gray-600 text-sm mb-3 flex items-center gap-1 group-hover:text-gray-700 transition-colors duration-300">
